...
const Navbar = () => {
 ...
 const {data} = await axios.post(backendUrl + '/api/auth/logout');
  ...
  <div className='absolute hidden group-hover:block top-6 right-0 z-10 text-black rounded mt-2'>
  ...
  : 
    <button onClick={() => navigate('/login')} className='flex items-center gap-2 border rounded-full px-6 py-2 text-gray-800 hover:bg-gray-100 transition-all cursor-pointer border-red-800'>
