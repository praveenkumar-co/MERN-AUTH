...
const Login = () => {
 ...
 const onSubmitHandler = async(e) => {
  try{
     // This will not allow page to reload again  
    e.preventDefault(); 
    //In order to send cookes  we will use this -> 
    ...
    if(state === 'Sign Up'){
     ...
     if(data.success){
      ...
      // if on submit form register did not take place then send an error using toast method -> 
  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to bg-purple-400">
      ...
      />
      <div className="bg-slate-900 p-10 rounded-1g shadow-lg w-full sm:w-96 text-indigo-300 text-sm rounded-2xl">
